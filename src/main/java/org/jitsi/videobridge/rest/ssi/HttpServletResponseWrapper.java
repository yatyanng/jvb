...
public class HttpServletResponseWrapper implements HttpServletResponse {
	/**
	 * Custom ServletOutputStream instance used to store the byte content of the
	 ...
	 */
	byte[] getContent() {
		return (outputStream == null) ? null : outputStream.resContent.toByteArray();
	}
	...
	private static class ByteArrayServletOutputStream extends ServletOutputStream {
		/**
		 * Used to store the content of the file to serve before processing it searching
