...
public class OsStatistics {
	...
	/**
	 * The <tt>OperatingSystemMXBean</tt> instance that is used to retrieve memory
	 * statistics.
	 */
	...
	public int getTotalMemory() {
		if (totalMemory == null) {
			Method method;
			try {
				method = operatingSystemMXBean.getClass().getMethod("getTotalPhysicalMemorySize");
			} catch (Exception e) {
	...
	public int getUsedMemory() {
		...
		if (freeMemoryMethod == null) {
			try {
				freeMemoryMethod = operatingSystemMXBean.getClass().getMethod("getFreePhysicalMemorySize");
			} catch (Exception e) {
