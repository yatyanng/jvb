    ...
    implements PropertyChangeListener
{
        ...
        throws IOException
    {
        ...
        synchronized (streamSyncRoot)
        {
            ...
            logger.info(getClass().getName() + " " + hashCode() + " creates "
            		+stream.getClass().getName() + " " + stream.hashCode());
    ...
    public void setRTPLevelRelayType(RTPLevelRelayType rtpLevelRelayType)
    {
        ...
        if (this.rtpLevelRelayType == null)
        {
            ...
            case MIXER:
                ...
                logger.info(getClass().getName() + " " + hashCode() + " assigns "
                		+ device.getClass().getName() + " " + device.hashCode()
                		+ " in "+stream.getClass().getName() + " " + stream.hashCode());
