...
class BundleContextHolder2 {
	/**
	 * The OSGi <tt>BundleContext</tt> in which this <tt>StartsTransport</tt> has
	 * been started and has not been stopped yet.
	 */
	private BundleContext bundleContext;

	/**
	 * Notifies this instance that the <tt>BundleContext</tt> it provides access to
	...
	/**
	 * Gets the OSGi <tt>BundleContext</tt> in which this <tt>StartsTransport</tt>
	 * has been started and has not been stopped yet.
	 *
	 * @return the OSGi <tt>BundleContext</tt> in which this
	 *         <tt>StartsTransport</tt> has been started and has not been stopped
	 *         yet
	 */
	 ...
	 *
	 * @param bundleContext the <tt>BundleContext</tt> in which this instance is to
	 *                      start
