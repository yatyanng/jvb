...
public class VideobridgeBundleActivator implements BundleActivator {
	/**
	 * The <tt>ServiceRegistration</tt> of a <tt>Videobridge</tt> instance within
	 ...
	 * Initializes and starts a new <tt>Videobridge</tt> instance and registers it
	...
	public void stop(BundleContext bundleContext) throws Exception {
		...
		try {
			videobridge = bundleContext.getService(serviceRegistration.getReference());
		} finally {
