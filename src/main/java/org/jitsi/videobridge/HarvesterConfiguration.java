...
public class HarvesterConfiguration {
	/**
	 * Contains the name of the property that would tell us if we should use address
	 * mapping as one of our NAT traversal options as well as the local address that
	 * we should be mapping.
	 * 
	 * @deprecated Use
	...
	/**
	 * Contains the name of the property that would tell us if we should use address
	 * mapping as one of our NAT traversal options as well as the public address
	 * that we should be using in addition to our local one.
	 * 
	 * @deprecated Use
	 ...
	 * 
	 * @deprecated Use {@link MappingCandidateHarvesters#FORCE_AWS_HARVESTER_PNAME}
	 */
	@Deprecated
	 ...
	 * server_address:port, separated by commas. Setting this property enables
	 * searching for our public address using the specified stun servers.
	 * 
	 * @deprecated Use
