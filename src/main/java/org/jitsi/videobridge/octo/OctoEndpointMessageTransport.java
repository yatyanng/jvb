...
public class OctoEndpointMessageTransport extends AbstractEndpointMessageTransport {
	/**
	 * The {@link Logger} used by the {@link RtpChannel} class and its instances to
	...
	/**
	 * We know this message came from another jitsi-videobridge instance (as opposed
	 * to a client endpoint), so we trust the ID that it provided.
	 * 
	...
	/**
	 * Overrides the default implementation to prevent the message from being sent
	 * on the Octo channel (which is where it came from).
	 *
