...
public interface TransformChainManipulator {
	...
	/**
	 * Manipulate transform engines and returns the new engine chain. Called when
	 * {@link RtpChannel} creates a new transform chain.
	 *
	 ...
	 */
	TransformEngine[] manipulate(TransformEngine[] transformEngines, Channel channel);
}
